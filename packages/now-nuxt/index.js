...
exports.build = async ({ files, workPath, entrypoint }) => {
  ...
  await Promise.all(
    Object.keys(pages).map(async (page) => {
      ...
      const pageFiles = {
        '.nuxt/dist/client/app.js': filesAfterBuild['.nuxt/dist/client/app.js'],
        '.nuxt/dist/client/commons.app.js':
          filesAfterBuild['.nuxt/dist/client/commons.app.js'],
        '.nuxt/dist/client/runtime.js':
          filesAfterBuild['.nuxt/dist/client/runtime.js'],
        [`.nuxt/dist/client/pages/${page}`]: filesAfterBuild[
          `.nuxt/dist/client/pages/${page}`
        ],
        '.nuxt/dist/server/index.spa.html':
          filesAfterBuild['.nuxt/dist/server/index.spa.html'],
        '.nuxt/dist/server/index.ssr.html':
          filesAfterBuild['.nuxt/dist/server/index.spa.html'],
        '.nuxt/dist/server/vue-ssr-client-manifest.json':
          filesAfterBuild['.nuxt/dist/server/vue-ssr-client-manifest.json'],
        '.nuxt/dist/server/server-bundle.json':
          filesAfterBuild['.nuxt/dist/server/server-bundle.json'],
      };
